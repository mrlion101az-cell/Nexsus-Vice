...
public class NexusVicePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.viceData = new ViceDataManager();
        ...
        getServer().getPluginManager().registerEvents(new ConsumeListener(substanceItems, alcoholItems, viceData, config), this);
        getCommand("vice").setExecutor(new ViceCommand(config, viceData, substanceItems, alcoholItems));
        ...
        getLogger().info("NexusVice enabled -- 8 original substances, 3 alcohol tiers, all invented, none of them real.");
    }
    ...
    public void onDisable() {
        // intentionally no per-player file persistence -- intoxication state is meant to be transient,
        // not something worth surviving a restart (a clean server restart is a reasonable place for
        // everyone to wake up sober)
    }
